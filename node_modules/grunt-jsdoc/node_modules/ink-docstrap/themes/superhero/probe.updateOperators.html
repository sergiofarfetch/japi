...
<head>
	<meta charset="utf-8">
	<title>DocStrap Class: updateOperators</title>
		...
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-1007">line 1007</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>Decrements a field by the amount you specify. It takes the form
<code>{ $dec: { field1: amount }</code></p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-245">line 245</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>Increments a field by the amount you specify. It takes the form
<code>{ $inc: { field1: amount } }</code></p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-225">line 225</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>The $pop operator removes the first or last element of an array. Pass $pop a value of 1 to remove the last element
in an array and a value of -1 to remove the first element of an array. This will only work on arrays. Syntax:
<code>{ $pop: { field: 1 } }</code> or <code>{ $pop: { field: -1 } }</code></p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-277">line 277</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>The $pull operator removes all instances of a value from an existing array. It looks like this:
<code>{ $pull: { field: &lt;query&gt; } }</code></p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-318">line 318</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>The $push operator appends a specified value to an array. It looks like this:
<code>{ $push: { &lt;field&gt;: &lt;value&gt; } }</code></p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-301">line 301</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>Removes the field from the object. It takes the form
<code>{ $unset: { field1: &quot;&quot; } }</code></p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="probe.js.html">documents/probe.js</a>,
				 <a href="probe.js.html#sunlight-1-line-265">line 265</a>
			</li>
		</ul>
	</dd>
...
probe.update( data, {&#x27;name.first&#x27; : &#x27;Yogi&#x27;}, {$unset : {&#x27;name.first&#x27; : &#x27;&#x27;}} );</pre>
		...
		on Fri Jul 4th 2014 using the <a
